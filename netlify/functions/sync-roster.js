...
import { whoIsCalling, resolveRole, fetchAll } from './_lib.js';
...
export default async (req, context) => {
  ...
  if (!coach && !admin) return new Response(
    `${auth.who} is not set up as a coach or admin. Ask Ben to add you, then reload.`,
    { status: 403 });
