...
export default async (req, context) => {
  ...
  if (!principal) delete fields['Owner']; /* a coach can't reassign ownership from here; Ben and admin staff can */
  ...
  try {
    ...
    if (rec && !principal && (rec.fields['Owner'] || '') !== coach) {
    ...
    if (!rec) {
      ...
      if (!fields['Owner'] && !principal) fields['Owner'] = coach;
